...
class AreaToolRegistry(
    ...
    fun findAllArea(): String {
        ...
        logger.error("Error retrieving area information", e)
        return "An error occurred while retrieving area information. Please try again later."
    }
    }
    ...
    fun findAreaById(id: String): String {
        ...
        try {
            ...
            logger.error("Error retrieving area information for ID {}", id, e)
            return "An error occurred while retrieving information for area ID '$id'. Please try again later."
        }
    }
