...
import com.wheretopop.shared.exception.BaseException
...
class CommonControllerAdvice {
    ...
    fun onException(e: Exception): CommonResponse<Nothing> {
        val eventId = MDC.get(com.wheretopop.shared.interceptor.CommonHttpRequestInterceptor.HEADER_REQUEST_UUID_KEY)
